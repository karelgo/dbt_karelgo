-- UWV Analytics Example Queries
-- These queries demonstrate key insights from the UWV unemployment insurance analytics
...
FROM silver_uwv_claims_analysis
...
FROM silver_uwv_claims_analysis u
